...
user1 = User.create(email: "hello1@email.com", first_name: "Vivian", last_name: "Wang", password: "abcdef")
user2 = User.create(email: "hello2@email.com", first_name: "Isaac", last_name: "Chen", password: "123456")
